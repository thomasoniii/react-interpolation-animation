...
var useInterpolate = function useInterpolate(current, setter) {
  ...
  var startTime = react.exports.useRef(performance.now()); // keep track of the last set of values at the start of the interpolation, defaulting
  // to the initial values.

  var previous = react.exports.useRef(initial); // keep track of the last frame of animation, in case we want to cancel it.

  var lastFrame = react.exports.useRef({}); // and further key each animation so we won't accidentally re-run something.
...
var Animation = function Animation(_ref) {
  ...
  var _useState = react.exports.useState(fullInitial),
  ...
  return /*#__PURE__*/React.cloneElement(child, _objectSpread2(_objectSpread2({}, localValues), {}, _defineProperty({}, ANIMATOR_INITIAL, undefined)));
};
...
var AnimationGroup = function AnimationGroup(props) {
  ...
  return React.Children.map(props.children, function (child) {
    return /*#__PURE__*/React.createElement(Animation, Object.assign({}, args, {
      child: child
    }));
  });
};
...
var Animator = function Animator(props) {
  ...
  return React.Children.count(args.children) > 1 ? /*#__PURE__*/React.createElement(AnimationGroup, args) : /*#__PURE__*/React.createElement(Animation, Object.assign({}, args, {
    child: React.Children.only(args.children)
  }));
};
